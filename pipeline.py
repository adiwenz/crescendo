...
def main():
    ...
    ap.add_argument("--reference", help="Reference WAV (optional). If provided, can be played during recording and used for similarity.")
    ap.add_argument("--no_record", action="store_true", help="Skip recording and reuse existing audio_files/<take_name>.wav")
    ap.add_argument("--play_reference", action="store_true", help="Play the reference while recording (requires --reference)")
    ...
    if not args.no_record:
        if args.reference and args.play_reference:
