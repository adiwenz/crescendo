...
def plot_results(times, midi_float, midi_nearest, cents_note_avg, note_names):
    ...
    Interactive Melodyne-style plot:
      ...
      • nearest note = orange LINE (flat per note)
    ...
    # Build nearest-note line (orange) that breaks between notes
    ...
    # Build sung-pitch line (blue) that also breaks between different notes
